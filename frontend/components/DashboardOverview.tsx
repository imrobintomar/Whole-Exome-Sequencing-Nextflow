...
export default function DashboardOverview() {
  ...
  return (
    <div className="space-y-8 animate-fade-slide-up">
      {/* Welcome Section */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/10 via-purple-500/5 to-cyan-500/10 dark:from-purple-500/20 dark:via-purple-500/10 dark:to-cyan-500/20 p-8 border border-purple-500/20">
        ...
        <div className="absolute -left-20 -bottom-20 h-40 w-40 rounded-full bg-gradient-to-br from-cyan-500/20 to-purple-500/20 blur-3xl" />

        <div className="relative">
          <div className="flex items-center gap-2 mb-2">
            <Sparkles className="h-5 w-5 text-purple-500" />
            <span className="text-sm font-medium text-purple-600 dark:text-purple-400">Dashboard Overview</span>
          </div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">
            Welcome to <span className="bg-gradient-to-r from-purple-600 to-cyan-600 dark:from-purple-400 dark:to-cyan-400 bg-clip-text text-transparent">ATGCFlow</span>
          </h1>
          ...
          <div className="flex gap-3 mt-6">
            <Button className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:opacity-90 text-white border-0 btn-press">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <div className="relative mb-4">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-cyan-500/20 rounded-full blur-xl" />
                <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/20">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="card-hover cursor-pointer border-dashed border-2 hover:border-purple-500/50 transition-colors group">
          <CardContent className="flex flex-col items-center justify-center py-8">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-500/10 group-hover:bg-purple-500/20 transition-colors">
        ...
        <Card className="card-hover cursor-pointer border-dashed border-2 hover:border-cyan-500/50 transition-colors group">
          <CardContent className="flex flex-col items-center justify-center py-8">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-500/10 group-hover:bg-cyan-500/20 transition-colors">
        ...
        <Card className="card-hover cursor-pointer border-dashed border-2 hover:border-teal-500/50 transition-colors group">
          <CardContent className="flex flex-col items-center justify-center py-8">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-teal-500/10 group-hover:bg-teal-500/20 transition-colors">
